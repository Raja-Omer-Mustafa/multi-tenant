        ...
        <div class="card-body">
            <div class="row">
                <div class="col-sm-12 mb-3">
                    <div class="mb-8">
                        <a href="{{ URL::to('roles/create') }}" class="btn btn-primary float-lg-right"><i
                    ...
                    <table class="table table-bordered table-striped mb-0" id="datatable-editable"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-title="Permissions" style="white-space: nowrap;">
                                ...
                                <td data-title="Actions">
                                    ...
                                    <a href="{{ URL::to('roles/'.$role->id.'/edit') }}" class="on-default edit-row"><i
                                            class="fas fa-pencil-alt"></i></a>

                                    {!! Form::open(['method' => 'DELETE', 'class' => 'delete', 'route' =>
                                    ['roles.destroy', $role->id] , 'style' => 'display:inline-block; color:red;
                                    width:20px;' ]) !!}
