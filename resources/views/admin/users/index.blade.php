    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-sm-12 mb-3">
                <div class="mb-4">
                    <a href="{{ route('users.create') }}" class="btn btn-primary float-lg-right"><i
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td data-title="Actions">
                                ...
                                <a href="{{ route('users.edit', $user->id) }}" class="on-default edit-row"><i
                                        class="fas fa-pencil-alt"></i></a>


                                {!! Form::open(['method' => 'DELETE', 'class' => 'delete', 'route' => ['users.destroy',
                                $user->id], 'style' => 'display: inline-block; color:red;' ]) !!}
